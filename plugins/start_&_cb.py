...
async def start(client, message):
    ...
    button = InlineKeyboardMarkup([[
      InlineKeyboardButton('📢 Updates', url='https://t.me/teamotaku109'),
      InlineKeyboardButton('💬 Support', url='https://t.me/animeotakugc109')
    ],[
      InlineKeyboardButton('⚙️ Help', callback_data='help'),
      InlineKeyboardButton('💙 About', callback_data='about')
    ],[
        InlineKeyboardButton("🧑‍💻 Developer 🧑‍💻", url='https://t.me/ZORO1SENPAI')
    ]])
    if Config.START_PIC:
